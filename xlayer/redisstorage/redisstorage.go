...
import (
	...
	"github.com/0xPolygonHermez/zkevm-bridge-service/xlayer/models/tokenlogo"
)
...
func (s *redisStorageImpl) AddBlockDeposit(ctx context.Context, deposit *etherman.Deposit) error {
	...
	key := s.addKeyPrefix(getBlockDepositListKey(uint(deposit.NetworkID), deposit.BlockNumber))
